...
# def baseline_drone_mpc_3(model, n_agents, x_baseline, x_dims, v_max, theta_max, phi_max, tau_max):
#     """ 
#     x_baseline : current concatenated states of all agents
...
#*****************************
#Below is for centralized set-up for 4 drones:
def baseline_drone_mpc_4(model, n_agents, x_baseline, x_dims, v_max, theta_max, phi_max, tau_max):
    """ 
    x_baseline : current concatenated states of all agents
    ...
    for j in range(6): #we have 6 pairwise distances for 4 agents, thus 6 distance constraints
        mpc.set_nl_cons(f'collision{j}', -model.aux[f'collision_avoidance{j}'], -0.3) 
